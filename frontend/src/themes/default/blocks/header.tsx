...
export function Header({ header }: { header: HeaderType }) {
  ...
  const solidPages = ['pdf-to-text', 'image-to-text', 'jpg-to-word', 'photo-to-word', 'pdf-to-word-doc', 'pdf-to-excel', 'pdf-to-md', 'contract-comparison', 'blog', 'upload', 'translate', 'ocrtranslator'];
  const isHomePage =
