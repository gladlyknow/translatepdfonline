...
export enum PaymentInterval {
  ...
  WEEK = 'week',
  MONTH = 'month',
  /** Billed every 3 months (e.g. Creem every-three-months) */
  QUARTER = 'quarter',
  /** Billed every 6 months (e.g. Creem every-six-months) */
...
export enum PaymentEventType {
  ...
  /** Creem: subscription entered trial (grant trial credits here) */
  SUBSCRIPTION_TRIALING = 'subscription.trialing',
  /** Acknowledge webhook without a payment session (Creem informational events) */
