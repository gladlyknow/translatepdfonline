...
export function SignUser({
  ...
  userNav?: UserNav;
  /** e.g. translate header on dark hero: light border/text */
      ...
      {isCheckSign || !mounted ? (
        ...
        <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
          <Button
            ...
            size={signButtonSize}
            className={cn(
              'ml-4 cursor-pointer border-border/60 bg-background/70 font-medium shadow-none ring-1 ring-border/40 backdrop-blur-sm hover:bg-muted/60 dark:border-white/15 dark:bg-transparent dark:ring-white/20 dark:hover:bg-white/10',
