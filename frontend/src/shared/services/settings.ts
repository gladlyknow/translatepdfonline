...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    {
      name: 'translate_fc',
      title: t('groups.translate_fc'),
      description:
        'PDF translation worker (FC). Optional if you set TRANSLATE_FC_URL / secrets on the Worker instead.',
      tab: 'general',
    },
    {
      name: 'email_auth',
...
export async function getSettings() {
  const settings: Setting[] = [
    {
      name: 'app_name',
      title: 'App Name',
      placeholder: 'Translate PDF Online',
      type: 'text',
      group: 'appinfo',
      tab: 'general',
    },
    {
      ...
      placeholder:
        'Translate PDF documents between English, Chinese, and Spanish. Preserve layout, secure and fast.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
    ...
    },
    {
      ...
      group: 'credit',
      tab: 'general',
      tip: 'description for initial credits (e.g. Welcome bonus; zh site may use 新用户赠送)',
    },
    {
      name: 'translate_fc_url',
      title: 'Translate FC URL',
      type: 'url',
      placeholder: 'https://xxx.fcapp.run/translate',
      group: 'translate_fc',
      tab: 'general',
      tip: 'Same as Worker vars TRANSLATE_FC_URL or BABELDOC_FC_URL. Use when FC URL is not in Dashboard.',
    },
    {
      name: 'translate_fc_secret',
      title: 'Translate FC Secret',
      type: 'password',
      placeholder: '',
      group: 'translate_fc',
      tab: 'general',
      tip: 'Sent as X-Babeldoc-Secret (or TRANSLATE_FC_AUTH_HEADER). Overrides env if set; prefer Worker secret in production.',
    },
    {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'translatepdfonline.com',
      group: 'plausible',
      tab: 'analytics',
    },
    {
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'Translate PDF Online <hello@translatepdfonline.com>',
      group: 'resend',
      tab: 'email',
    },
    {
