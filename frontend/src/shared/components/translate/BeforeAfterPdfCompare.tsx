...
export function BeforeAfterPdfCompare({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative mx-auto aspect-[16/10] w-full max-w-3xl max-h-[240px] overflow-hidden rounded-xl border border-zinc-200 bg-white/90 shadow-[0_8px_30px_-12px_rgba(14,165,233,0.2)] dark:border-white/10 dark:bg-slate-900/50 dark:shadow-[0_0_40px_-12px_rgba(56,189,248,0.35)] sm:max-h-[320px]"
        onKeyDown={onKeyDown}
      >
        {/* Before — full frame */}
        <img
          ...
          draggable={false}
        />
        <span className="pointer-events-none absolute left-2 top-2 rounded bg-black/50 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-zinc-200">
        ...
        <span className="pointer-events-none absolute right-2 top-2 rounded bg-black/50 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-sky-200">
          {t('compareAfterLabel')}
        </span>
