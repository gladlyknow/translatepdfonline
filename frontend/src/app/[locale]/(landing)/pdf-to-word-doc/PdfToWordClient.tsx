            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 rounded-xl border border-emerald-200/80 bg-emerald-50/70 px-4 py-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {file.type || 'PDF'} · {(file.size / 1024).toFixed(0)} KB
                  </p>
                </div>
                <Button
                  variant="ghost"
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  disabled={processing || uploading || !!job}
                  className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground/50 focus:border-sky-700 focus:outline-none focus:ring-1 focus:ring-sky-700 disabled:opacity-50"
                />
              </div>
