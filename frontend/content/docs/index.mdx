...
On the **[Translate PDF](/translate/upload)** screen, the **History** column is central to your workflow:
...
- [Upload workflow](/docs/upload)
- [OCR workbench](/docs/ocr-workbench)

- [PDF to Text](/docs/pdf-to-text)
- [Image to Text](/docs/image-to-text)
- [Contract Comparison](/docs/contract-comparison)
