...
class HeifDepthImage(BaseImage):
    """Class representing the depth image associated with the :py:class:`~pi_heif.HeifImage` class."""
...
class HeifAuxImage(BaseImage):
    """Class representing the auxiliary image associated with the :py:class:`~pi_heif.HeifImage` class."""
...
class HeifImage(BaseImage):
    """One image in a :py:class:`~pi_heif.HeifFile` container."""
...
class HeifFile:
    """Representation of the :py:class:`~pi_heif.HeifImage` classes container.
    ...
    * :py:func:`~pi_heif.from_bytes`
    ...
    @property
    def size(self):
        """:attr:`~pi_heif.HeifImage.size` property of the primary :class:`~pi_heif.HeifImage`.
    ...
    @property
    def mode(self):
        """:attr:`~pi_heif.HeifImage.mode` property of the primary :class:`~pi_heif.HeifImage`.
    ...
    @property
    def has_alpha(self):
        """:attr:`~pi_heif.HeifImage.has_alpha` property of the primary :class:`~pi_heif.HeifImage`.
    ...
    def premultiplied_alpha(self):
        """:attr:`~pi_heif.HeifImage.premultiplied_alpha` property of the primary :class:`~pi_heif.HeifImage`.
    ...
    @property
    def data(self):
        """:attr:`~pi_heif.HeifImage.data` property of the primary :class:`~pi_heif.HeifImage`.
    ...
    @property
    def stride(self):
        """:attr:`~pi_heif.HeifImage.stride` property of the primary :class:`~pi_heif.HeifImage`.
    ...
    @property
    def info(self):
        """`info`` dict of the primary :class:`~pi_heif.HeifImage` in the container.
    ...
    def get_aux_image(self, aux_id):
        """`get_aux_image`` method of the primary :class:`~pi_heif.HeifImage` in the container.
...
def _encode_images(images: list[HeifImage], fp, **kwargs) -> None:
    ...
    if not _pi_heif.get_lib_info()[compression]:
...
def from_pillow(pil_image: Image.Image) -> HeifFile:
    """Creates :py:class:`~pi_heif.HeifFile` from a Pillow Image.
...
def from_bytes(mode: str, size: tuple[int, int], data, **kwargs) -> HeifFile:
    """Creates :py:class:`~pi_heif.HeifFile` from bytes.
